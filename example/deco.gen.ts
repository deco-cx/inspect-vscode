...
import * as $1 from "./routes/inspect-vscode.ts";
import * as $$0 from "./islands/InspectVSCode.tsx";
import * as $$$0 from "./components/Footer.tsx";
import * as $$$1 from "./components/Head.tsx";
import * as $$$2 from "./components/Header.tsx";
import * as $$$3 from "./components/Hero.tsx";

const manifest = {
  routes: { "./routes/index.tsx": $0, "./routes/inspect-vscode.ts": $1 },
  islands: { "./islands/InspectVSCode.tsx": $$0 },
  components: {
    "./components/Footer.tsx": $$$0,
    "./components/Head.tsx": $$$1,
    "./components/Header.tsx": $$$2,
    "./components/Hero.tsx": $$$3,
  },
  twind: {
    mode: "warn",
    theme: {
      ...
      backgroundImage: {
        none: "none",
        "gradient-silver":
          "linear-gradient(45deg, #000000 0%, #001155 30%, #0047dc 90%)",
        "gradient-blue":
          "linear-gradient(120deg, #FFFFFF 0%, #3168F5 45%, #0055fe 65%, #001155 100%)",
        "gradient-white":
